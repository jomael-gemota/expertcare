				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div id="customerDetailsMessage"></div>
					 <form> 
					  <div class="form-row">
						<div class="form-group col-md-6">
						  <label for="customerDetailsCustomerFullName">Full Name (Lastname, Firstname Middlename)<span class="requiredIcon">*</span></label>
					  ...
					  <div class="form-group">
						<label for="customerDetailsCustomerAddress2">Cheif Complaint</label>
					  ...
					  <div class="form-row">
						...
						<div class="form-group col-md-4">
						  <label for="customerDetailsCustomerDistrict">Province</label>
					  ...
					  <button type="button" id="updateCustomerDetailsButton" class="btn btn-primary">Update
					  <button type="reset" class="btn">Clear</button>
					 </form>
				  </div> 
				</div>
